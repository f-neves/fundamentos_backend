	...
	protected void doGet(HttpServletRequest request, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			case "soma":
				...
				mensagem = "A soma desses dois números é: " + operacao;
				break;
				
			case "subtracao":
				resultado = numero1 - numero2;
				mensagem = "A subtração desses dois números é: : " + operacao;
				break;
				
			case "divisao":
				resultado = numero1 / numero2;
				mensagem = "A divisão desses dois números é: : " + operacao;
				break;
				
			case "multiplicacao":
				resultado = numero1 * numero2;
				mensagem = "A multiplicação desses dois números é: : " + operacao;
				break;
